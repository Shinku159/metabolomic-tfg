...
class LstmModel(tf.keras.Model):
  ...
  **kwargs: Json object,
  ...
  def __init__(self, inputShape, outputShape, **kwargs):
    ...
    self.lstm5 =  tf.keras.layers.LSTM(units=64, activation=tf.nn.relu, return_sequences=False)
  ...
  def buildCompile(self, **kwargs):
    optimizer = kwargs.get('optimizer', tf.keras.optimizers.RMSprop(learning_rate=1e-5))
